# Graze - JIRA to Azure DevOps Bridge Plugin
...
### Setup Steps
1. Open the Graze tool window from the right sidebar or via `Tools → Graze → Open Graze Tool Window`
...
### Project Structure
```
src/main/kotlin/com/bloomware/graze/
