 ...
 */
class GrazeSettingsDialog(private val project: Project) : DialogWrapper(project) {
    
    private val config = GrazeConfigurationService.getInstance()
        ...
        ProgressManager.getInstance().run(object : Task.Backgroundable(project, "Testing JIRA Connection", false) {
            override fun run(indicator: ProgressIndicator) {
                ...
                javax.swing.SwingUtilities.invokeLater {
                    ...
                    when (result) {
                        is com.bloomware.graze.model.ApiResult.Success -> {
                        ...
                        is com.bloomware.graze.model.ApiResult.Error -> {
